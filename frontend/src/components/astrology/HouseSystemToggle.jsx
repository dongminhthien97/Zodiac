...
import { HOUSE_SYSTEMS } from '../../constants/layers'
import { useUserPreferences } from '../../contexts/UserPreferencesContext'

const HouseSystemToggle = ({ availableSystems, currentSystem, onSwitch }) => {
    ...
    return (
        <div className="flex justify-center mb-8">
            <div className="bg-white/10 p-1 rounded-xl inline-flex relative shadow-inner">
                ...
                >
                    {HOUSE_SYSTEMS.whole_sign[language]}
                </button>
                ...
                >
                    {HOUSE_SYSTEMS.placidus[language]}
                </button>
            </div>
        </div>
    )
