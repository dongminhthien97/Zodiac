...
interface DeduplicationContextValue {
    ...
    trackContent: (text: string) => boolean;
    reset: () => void;
}
...
interface DeduplicationProviderProps {
    children: ReactNode;
    onDuplicateDetected?: (text: string, hash: string) => void;
}
 ...
 */
export const DeduplicationProvider = ({ children, onDuplicateDetected }: DeduplicationProviderProps) => {
